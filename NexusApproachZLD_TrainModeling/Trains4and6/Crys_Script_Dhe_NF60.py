...
if __name__ == "__main__":
    ...
    m.fs.unit.crystallization_yield["NaCl"].fix(0.5) #vary according to desired solid salt yield

    # Move height upper bound
    m.fs.unit.height_crystallizer.setub(50)

    # specify the flowsheet
    m.fs.unit.inlet.flow_mass_phase_comp[0, "Liq", "NaCl"].fix(15.856) #vary based on LSRRO brine
    m.fs.unit.inlet.flow_mass_phase_comp[0, "Liq", "H2O"].fix(80.103)  #vary based on LSRRO brine
