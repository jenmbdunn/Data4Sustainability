...
def set_operating_conditions(m, Cin=None, Qin=None):
    ...
    for pump in m.fs.PrimaryPumps.values():
        ...
        #iscale.set_scaling_factor(pump.control_volume.work, 1e-3) #default WaterTAP scaling
        iscale.set_scaling_factor(pump.control_volume.work, 1e-5) #adjusted scaling
    ...
    for erd in m.fs.EnergyRecoveryDevices.values():
        ...
        #iscale.set_scaling_factor(erd.control_volume.work, 1e-3) #default WaterTAP scaling
        iscale.set_scaling_factor(erd.control_volume.work, 1e-5) #adjusted scaling
    ...
    #m.fs.properties.set_default_scaling("flow_mass_phase_comp", 1e2, index=("Liq", "TDS")) #default scaling
