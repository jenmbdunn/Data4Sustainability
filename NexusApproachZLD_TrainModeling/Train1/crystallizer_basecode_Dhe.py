    ...
    **Valid values:** {
    ...
    def build(self):
        ...
        self.work_mechanical = Var(
            ...
            #initialize=1e5, #WaterTAP default initial value
            initialize=1e8, #adjusted initial value
            bounds=(-5e6, 5e6),
        ...
        self.diameter_crystallizer = Var(
            #initialize=3, #WaterTAP default initial value
            initialize=24, #adjusted initial value
            bounds=(0, 25),
            units=pyunits.m,
